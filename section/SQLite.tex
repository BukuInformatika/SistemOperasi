...
\end{enumerate}
\subsection{SQL and relational model}
\begin{enumerate}
\item SQL dan Relational Model Bab ini menyajikan akar teoritis dari SQL, dan memeriksa kekuatan dan keanggunan di belakang SQL. Ini mempersiapkan Anda untuk berurusan dengan SQL tidak dalam isolasi tetapi dalam konteks model relasional. Jika tidak ada yang lain, ini akan memberi Anda apresiasi untuk seberapa elegan, kuat, dan kompleksnya sebuah database relasional. Anda mungkin dikejutkan oleh apa yang bahkan dimiliki oleh database relasional yang paling dasar sekalipun. Anda tidak perlu membaca bab ini untuk memahami SQL; itu hanya memberikan latar belakang teoretis dan historis. Untuk tujuan ini, saya menyajikan aspek teoritis dalam beberapa makalah dan artikel yang berpengaruh yang ditulis oleh Codd antara 1970 dan 1985 yang mendefinisikan esensi dari model relasional, bersama dengan ide dan karya kontributor lain ke lapangan. Dua makalah Codd yang disebutkan di sini tersedia online, dan terdaftar di bagian Referensi di akhir bab ini. Sekali lagi, yang lain berkontribusi pada pengembangan model relasional, tetapi bab ini terutama akan diambil dari karya Codd.
\end{enumerate}
