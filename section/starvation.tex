%Nama Kelompok: Sistem_Operasi_Starvation
%Kelas: D4 TI 1B
...
sehingga dapat mengakibatkan suatu kejadian, yaitu ìstarvationî atau kelaparan, Starvation berbarengan dengan deadlock sesuai dengan gambar \ref{starvationvsdeadlock}.  
...
Starvation terjadi pada proses proses penjadwalan yang menggunakan prinsip Ågproses yang paling cepat diselesaikan didahulukanÅh, seperti pada Shortest Job First atau yang biasa di singkat SJF dan Penjadwalan Prioritas.
...
Bounded Waiting memiliki maksimum jumlah waktu yang diijinkan oleh proses lain untuk memasuki critical section atau disebut juga bagian penting  setelah sebuah proses membuat permintaan untuk memasuki critical section-nya dan sebelum permintaan dikabulkan. Batasanñbatasan itu biasanya menjamin proses dapat mengakses ke ìcritical sectionî (tidak mengalami starvation: proses se-olah berhenti menunggu request akses ke critical section diperbolehkan).
