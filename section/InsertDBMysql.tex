\section{Cara Insert Database Mysql}
	...
	Di dalam query saat pembuatan table mata_kuliah, kolom jumlah SKS ditafsirkan memiliki nilai default 2, ajdi jika kolom ini tidak diisi pun , akan tetap menggunakan nilai defaultnya yaitu 2.
