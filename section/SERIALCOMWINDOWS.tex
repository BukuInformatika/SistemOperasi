...
\end{verbatim}	
	...
	\subsection{Serial Status}
		...
		\end{enumerate}
			...
			\ite WaitCommEvent menerbitkan pemeriksaan status. Pemeriksaan status dapat berupa operasi tumpang-tindih atau non-tumpang tindih, seperti halnya operasi baca dan tulis.
