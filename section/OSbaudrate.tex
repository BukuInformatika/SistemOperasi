...
Karena baud rate tidak membedakan apakah informasi yang ditransmisikan adalah data atau hanya memberi isyarat informasi yang diguna kan oleh perangkat keras untuk melakukan sinkronisasi, menentukan jalan nya, dan banyak hal lain yang dilakukan pada sinkronisasi . Tingkat baud rate mencakup overhead . Jadi jika setiap simbol mengandung 4 bi t, bit rate bersih sedikit kurang dari empat kali dari baud rate . Perbedaan nya biasa nya sangat kecil dan seharus nya tidak mempengaruhi transmisi data yang terlalu banyak.
