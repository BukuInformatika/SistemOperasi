...
\section{Komunikasi Serial pada Linux}
	...
	perbedaan metode port serial dengan port USB:
	perbedaannya adalah pada media penghubungnya, yaitu di port USB tidak menggunakan rangkaian RS232 sebagai media pengirim dan menerima data.
	sedangkan metode port serial menggunakan rangkaian tambahan, yaitu rangkaian RS232 dan kabel serial sebagai penghubungnya.
