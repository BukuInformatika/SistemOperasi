...
\section {Tipe Fragmentasi}
\subsection {Fragmentasi Horisontal}
Jika dilihat dari segi prosesnya , proses fragmentasi horizontal sangat berhubungan dengan isi dari datanya. Oleh sebab itu , frgmentasi Horisontal dibuat dengan cara memecah isi dari suatu tabel dengan menetapkan sebuah predikat.
 
\subsection {Fragmentasi Vertical}
Jika dilihat dari segi prosesnya , pada proses fragmentasi vertikal berhubungan dengan atribut dari tabel yang bersangkutan. Cara membuat Fragmentasi vertikal yaitu dibuat dengan cara memecah dari atribut dari tabel.
%%%%%%%% Rizal Rony Sitorus %%%%%%%%

\section {Aturan dalam Fragmentasi}
Pada aturan proses fragmentasi , kepingan-kepingan yang berada dari fragmen harus dijaga kekomplitannya. Sehingga  , aturan-aturan frakmentasi haruslah diikuti. Adapun  aturan-aturannya antara lain :
• Completeness
Apabila relasi r dibagi menjadi fragment r1, r2, r3, maka akan dinyatakan complete jika dan hanya jika pada setiap item data dalam r dapat ditemukan pada satu atau lebih fragmen Ri untuk memastikan tidak
